...
export function Hero() {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden bg-white dark:bg-zinc-950">
        ...
        <svg className="absolute inset-0 w-full h-full opacity-10 md:opacity-20" xmlns="http://www.w3.org/2000/svg">
          <defs>
            ...
            <pattern id="grid-pattern" width="80" height="80" patternUnits="userSpaceOnUse">
              ...
              <path d="M 0 40 Q 20 35, 40 40 T 80 40" stroke="url(#grid-gradient)" strokeWidth="0.5" fill="none" opacity="0.4">
                <animate attributeName="d" 
                  values="M 0 40 Q 20 35, 40 40 T 80 40;M 0 40 Q 20 45, 40 40 T 80 40;M 0 40 Q 20 35, 40 40 T 80 40" 
                  dur="6s" 
                  repeatCount="indefinite" />
              </path>
              <path d="M 40 0 Q 35 20, 40 40 T 40 80" stroke="url(#grid-gradient)" strokeWidth="0.5" fill="none" opacity="0.4">
                <animate attributeName="d" 

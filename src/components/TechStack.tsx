...
import { techStackCategories, badgeLabels, TechBadge } from '../data/techStackData';
                      ...
                      <div className="relative bg-zinc-50 dark:bg-zinc-800 rounded-lg px-3 py-2 border border-zinc-200 dark:border-zinc-700 hover:border-purple-500/50 transition-all duration-300">
                        ...
                        {tech.badges && tech.badges.length > 0 && (
                          <div className="absolute -top-1 -right-1 flex gap-0.5">
                            {tech.badges.slice(0, 2).map((badgeKey) => {
                              ...
                              return (
                                <motion.div
                                  ...
                                  initial={{ scale: 0 }}
                                  animate={{ scale: 1 }}
                                  transition={{ delay: categoryIndex * 0.1 + techIndex * 0.02 + 0.2 }}

  ...
  },
  {
    ...
    details: {
      pt: {
        ...
        funFact: '⚽ Time do coração: Internacional | 🏃 Melhor tempo 5k: 24min | 🎯 Meta: completar uma meia-maratona',
      },
      en: {
      ...
      es: {
        ...
        funFact: '⚽ Equipo del corazón: Internacional | 🏃 Mejor tiempo 5k: 24min | 🎯 Meta: completar una media maratón',
      },
    },
    images: [
      {
  ...
  },
  {
    ...
    details: {
      pt: {
        ...
        funFact: '🎌 Animes assistidos: 150+ | 🏆 Gênero favorito: Seinen/Thriller Psicológico | 📚 Também leio mangas',
      },
      en: {
        ...
        funFact: '🎌 Anime watched: 150+ | 🏆 Favorite genre: Seinen/Psychological Thriller | 📚 I also read manga',
      },
      es: {
        ...
        funFact: '🎌 Animes vistos: 150+ | 🏆 Género favorito: Seinen/Thriller Psicológico | 📚 También leo mangas',
      },
    },
  },
  {
    ...
    details: {
      pt: {
        ...
        funFact: '📺 Plataforma mais usada: Netflix/HBO | 🎬 Prefiro séries limitadas/minisséries | ⏸️ Raramente assisto episódios isolados',
      },
      en: {
        ...
        funFact: '📺 Most used platform: Netflix/HBO | 🎬 I prefer limited series/miniseries | ⏸️ I rarely watch isolated episodes',
      },
      es: {
        ...
        funFact: '📺 Plataforma más usada: Netflix/HBO | 🎬 Prefiero series limitadas/miniseries | ⏸️ Rara vez veo episodios aislados',
      },
    },
  },
  {
    ...
    details: {
      pt: {
        ...
        funFact: '🎬 Filmes assistidos por ano: ~80 | 🍿 Gênero favorito: Sci-Fi/Thriller | 📽️ Sempre assisto com áudio original + legendas',
      },
      en: {
        ...
        funFact: '🎬 Movies watched per year: ~80 | 🍿 Favorite genre: Sci-Fi/Thriller | 📽️ Always watch with original audio + subtitles',
      },
      es: {
        ...
        funFact: '🎬 Películas vistas por año: ~80 | 🍿 Género favorito: Sci-Fi/Thriller | 📽️ Siempre veo con audio original + subtítulos',
      },
    },
  },
];